                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <form action="<?= base_url('tamu/pilihgerbong'); ?>" method="post">
                                        ...
                                        <input type="hidden" name="no_tiket" value="<?= $d['no_tiket']; ?>">
                                        <input type="hidden" name="id_penumpang" value="<?= $d['id_penumpang']; ?>">
                                        <img src="assets/img/gerbong/gerbong1.jpg" class="img-fluid img-thumbnail">
                                        <div class="form-group">
                                            <h5> Pilihan Gerbong</h5>
                                        ...
                                        <div class="form-group">
                                        <h5> Pilihan Bagian Kursi</h5>
                                            <select name="kursiA" class="form-control bagianA">
                                        ...
                                        <div class="form-group">
                                            <select name="kursiB" class="form-control bagianB">
