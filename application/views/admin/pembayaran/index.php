                            ...
                            <tbody>
                                <?php foreach ($pembayaran as $p) : ?>
                                    <tr>
                                        ...
                                        <td>
                                        <button type="button" class="btn btn-success btn-sm tombolTambahKursi" data-toggle="modal" data-target="#formbayar"><i class="fas fa-plus-circle"></i> Verifikasi</button>
...
<div class="modal fade" id="formbayar" tabindex="-1" aria-labelledby="formStasiunModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="formStasiunModalLabel">Verifikasi</h5>
                
            </div>
            <div class="modal-body">
                <form method="post" action="<?= base_url('admin/verifikasi/') . $p['id_pembayaran']; ?>">
                    
                    <label for="kursi">Yakin Konfirmasi Pembayaran</label>
