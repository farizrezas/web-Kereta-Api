  ...
  <div class="container">
    <div class="row">
    	<div class="col-md-12 mt-5"> 
			<!--<marquee-->
    			<h1 class="display-4 mt-12 text-light judul" align="center" style="margin-bottom: revert;">Selamat Datang Di PT.Kereta API </h1>
			<!--</marquee-->
    	</div>	
    		...
    		<div class="card">
    			...
    			<div class="card-body" >
    				<form action="<?= base_url('tamu/cari_tiket'); ?>" method="post">
    					...
    					<div class="form-group">
    						<button type="submit" class="btn btn-dark btn-block "style="margin-left: px" ><i class="fas fa-search"></i> Cari Tiket</button>
    					</div>
    				</form>
    			</div>
    		</div>
